package br.com.catolica.gateway.auth;
...
public class TokenController {
    ...
    public ResponseEntity<String> token(@RequestBody User user) {
        ...
        return restTemplate.postForEntity("http://localhost:8080/realms/gateway/protocol/openid-connect/token", entity, String.class);
